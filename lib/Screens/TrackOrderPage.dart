        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              decoration: const BoxDecoration(
                image: DecorationImage(
                  image: AssetImage(
                      'assets/images/map.png'), // Correct the asset path
                  fit: BoxFit.cover,
                ),
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(
                        10.0), // Border radius for the row
                  ),
                  ...
                  child: CircleAvatar(
                    ...
                    child: Image.asset(
                      'assets/images/profile.jpeg', // Replace with the path to your delivery person image
                ...
                Container(
                  decoration: const BoxDecoration(
                    ...
                    color:
                        Colors.purple, // Change the background color as needed
                  ),
                  padding:
            ...
            ClipRRect(
              ...
              child: Container(
                color:
                    const Color(0xffF8F9FB), // Set the desired background color
                padding:
                    const EdgeInsets.all(16.0), // Add padding to the section
                child: const Column(
                  children: [
                    SizedBox(height: 20),
                    Row(
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Padding(
                              padding: EdgeInsets.only(top: 20),
                              child: Text(
                                '05-july-2024', // Replace with the actual order code
                                style: TextStyle(
                                  fontSize: 14,
                                  fontWeight: FontWeight.w400,
                                  color: Color(0xff616A7D),
